...
function Sidebar({ isOpen, onClose, onExportPdf, onSaveSimulation }: SidebarProps) {
  return (
    <>
      ...
      >
        <div className="mb-10">
          <p className="text-xs uppercase tracking-[0.15em] text-emerald-600">TaxFlow</p>
          <h1 className="text-2xl font-semibold text-slate-900 dark:text-slate-100">
            TaxFlow 2026
          </h1>
          <p className="mt-2 text-sm text-slate-500 dark:text-slate-400">Colombian tax simulator</p>
        </div>
